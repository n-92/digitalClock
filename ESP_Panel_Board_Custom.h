...
#define ESP_PANEL_LCD_RGB_HFP (8)  // Changed from 210 to 8
#define ESP_PANEL_LCD_RGB_VPW (4)
#define ESP_PANEL_LCD_RGB_VBP (16)
#define ESP_PANEL_LCD_RGB_VFP (150)
...
#define ESP_PANEL_LCD_RGB_BOUNCE_BUF_SIZE (8000) // Bounce buffer size in bytes. This function is used to avoid screen drift.
